...
export function CtaBand() {
  return (
    <section className="surface-navy relative overflow-hidden">
      <div
        aria-hidden
        className="pointer-events-none absolute -left-20 bottom-0 h-80 w-80 rounded-full opacity-25 blur-3xl"
      ...
      <div className="container-ehed relative grid gap-8 py-16 lg:grid-cols-[1.4fr_auto] lg:items-center lg:py-20">
        <Reveal>
          ...
          <h2 className="mt-3 max-w-2xl text-3xl leading-tight text-white sm:text-4xl">
            Ready to enter or expand across East African markets?
          </h2>
          <p className="mt-4 max-w-xl text-white/70">
            Talk to our team in Kigali about trade facilitation, sourcing, representation and export
            opportunities.
          </p>
        </Reveal>
        <Reveal delay={0.1}>
