...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Experience House (EHED) is a Rwanda-based regional trade and business development company connecting East Africa with the Middle East and North Africa." },
      { name: "twitter:description", content: "Experience House (EHED) is a Rwanda-based regional trade and business development company connecting East Africa with the Middle East and North Africa." },
